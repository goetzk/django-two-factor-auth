...
from ..forms import (
    ...
    # FIXME: these four should end up in backends and be conditionally imported
...
# TODO: these views will be the hardest bit to do dynamically.
    """
    ...
    initial_dict = {}
    # FIXME: needs to come in dynamically
    form_list = (
        ('welcome', Form),
        ('method', MethodForm),
